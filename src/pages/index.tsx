    ...
    function Expansion({expansion}: {expansion: any}) {
        ...
        return (
            <motion.div
                ...
                className={`vignette ${expansion} ${expansions?.includes(expansion) ? "active" : null} border-4 4k:border-8 w-9/12 h-32 4k:h-60 md:w-3/12 md:h-44 border-slate-100/70 -skew-x-12 group duration-100 overflow-hidden shadow-lg shadow-black/50 relative cursor-pointer py-4 px-16 rounded-xl`}
            >
