export default function ScoreToolTip() {
    ...
    return (
        <div className="group absolute top-1 right-2 z-50 p-2">
            ...
            <div className="duration-200 scale-0 group-hover:scale-100 origin-bottom absolute top-0 right-1/2 bg-gradient-to-b from-blue-800 to-blue-900 border-2 border-slate-200 shadow shadow-black/50 translate-x-1/2 -translate-y-full p-3 rounded-lg">
