...
export default function ScoreToolTip({ isMobile } : Props) {
    return (
        <div className="group absolute top-1 right-2 z-50 p-2">
            ...
            <div className={`${isMobile ? "origin-top-right top-0 right-10" : "origin-bottom top-0 right-1/2 translate-x-1/2 -translate-y-full" } duration-200 scale-0 group-hover:scale-100 absolute bg-gradient-to-b from-blue-800 to-blue-900 border-2 border-x-[#c0a270] border-y-[#e0c290] shadow shadow-black/50 p-3 rounded-lg`}>
